...
// Lab 1 §7/§10: the health-check + category-list landing page. Extracted
// out of App.tsx in Lab 2 so App.tsx can own routing/shell concerns while
// this stays a plain, router-independent component (and keeps the existing
// Lab 1 test suite working unchanged).
function HomePage() {
